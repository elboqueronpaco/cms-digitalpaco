import { isArray, isDefined, isFunction, isJson, isNumber, isObject, isPassword, isString, isUndefined } from '../is'
const Jsonstr = JSON.stringify
describe('#isArray', () => {
  it('should return true if is an Array', () => {
    expect(isArray([1, 2, 3])).toBe(true)
  })
  it('should  return if is not an Array', () => {
    expect(isArray({
      bar: 'bar',
      foo: 'foo'
    })).toBe(false)
...
describe('#isDefined', () => {
  ...
  it('should  return false if a variabe is undefined', () => {
    let test
    expect(isDefined(test)).toBe(false)
  })
})
describe('#isFunction', () => {
  it('shold be true if variable is a function', () => {
    const test = () => 'bar'
    expect(isFunction(test)).toBe(true)
  })
  it('should be false if variable is a function', () => {
    const test = 'bar'
...
describe('#isJson', () => {
  it('should be true if a varible is a valid json', () => {
    const test = Jsonstr({
      foo: {
        bar: true
      }
  ...
  it('should be false if a variable is a valid json', () => {
